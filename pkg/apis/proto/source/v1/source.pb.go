...
var file_pkg_apis_proto_source_v1_source_proto_depIdxs = []int32{
	...
	16, // 6: source.v1.AckResponse.result:type_name -> source.v1.AckResponse.Result
	17, // 7: source.v1.PendingResponse.result:type_name -> source.v1.PendingResponse.Result
	18, // 8: source.v1.PartitionsResponse.result:type_name -> source.v1.PartitionsResponse.Result
	10, // 9: source.v1.ReadResponse.Result.offset:type_name -> source.v1.Offset
	19, // 10: source.v1.ReadResponse.Result.event_time:type_name -> google.protobuf.Timestamp
	14, // 11: source.v1.ReadResponse.Result.headers:type_name -> source.v1.ReadResponse.Result.HeadersEntry
	0,  // 12: source.v1.ReadResponse.Status.code:type_name -> source.v1.ReadResponse.Status.Code
	1,  // 13: source.v1.ReadResponse.Status.error:type_name -> source.v1.ReadResponse.Status.Error
