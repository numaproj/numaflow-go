...
func (c *sourceTransformerClient) SourceTransformer(ctx context.Context, in *SourceTransformerRequest, opts ...grpc.CallOption) (*SourceTransformerResponseList, error) {
	...
	err := c.cc.Invoke(ctx, "/source.transformerfn.SourceTransformer/SourceTransformer", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *sourceTransformerClient) IsReady(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ReadyResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/source.transformerfn.SourceTransformer/IsReady", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _SourceTransformer_SourceTransformer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/source.transformerfn.SourceTransformer/SourceTransformer",
	}
...
func _SourceTransformer_IsReady_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/source.transformerfn.SourceTransformer/IsReady",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var SourceTransformer_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "source.transformerfn.SourceTransformer",
	...
	Metadata: "pkg/apis/proto/source/transformerfn/transformer.proto",
}
