...
var file_pkg_apis_proto_mapstream_v1_mapstream_proto_goTypes = []any{
...
func file_pkg_apis_proto_mapstream_v1_mapstream_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pkg_apis_proto_mapstream_v1_mapstream_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_pkg_apis_proto_mapstream_v1_mapstream_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_pkg_apis_proto_mapstream_v1_mapstream_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_pkg_apis_proto_mapstream_v1_mapstream_proto_msgTypes[4].Exporter = func(v any, i int) any {
