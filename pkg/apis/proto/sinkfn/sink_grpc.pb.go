...
func (c *sinkClient) SinkFn(ctx context.Context, opts ...grpc.CallOption) (Sink_SinkFnClient, error) {
	stream, err := c.cc.NewStream(ctx, &Sink_ServiceDesc.Streams[0], "/sinkfn.Sink/SinkFn", opts...)
	if err != nil {
		return nil, err
	}
...
type Sink_SinkFnClient interface {
	...
	CloseAndRecv() (*SinkResponseList, error)
	grpc.ClientStream
}
...
func (x *sinkSinkFnClient) CloseAndRecv() (*SinkResponseList, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(SinkResponseList)
...
func (c *sinkClient) IsReady(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ReadyResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/sinkfn.Sink/IsReady", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type Sink_SinkFnServer interface {
	SendAndClose(*SinkResponseList) error
...
func (x *sinkSinkFnServer) SendAndClose(m *SinkResponseList) error {
...
func _Sink_IsReady_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/sinkfn.Sink/IsReady",
	}
...
var Sink_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "pkg/apis/proto/sinkfn/sink.proto",
}
