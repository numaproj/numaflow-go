...
// Source: github.com/numaproj/numaflow-go/pkg/apis/proto/sinkfn (interfaces: SinkClient,Sink_SinkFnClient)
...
import (
	...
	sinkfn "github.com/numaproj/numaflow-go/pkg/apis/proto/sinkfn"
...
func (m *MockSinkClient) IsReady(arg0 context.Context, arg1 *emptypb.Empty, arg2 ...grpc.CallOption) (*sinkfn.ReadyResponse, error) {
	m.ctrl.T.Helper()
	...
	ret0, _ := ret[0].(*sinkfn.ReadyResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockSinkClient) SinkFn(arg0 context.Context, arg1 ...grpc.CallOption) (sinkfn.Sink_SinkFnClient, error) {
	m.ctrl.T.Helper()
	...
	ret0, _ := ret[0].(sinkfn.Sink_SinkFnClient)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockSink_SinkFnClient) CloseAndRecv() (*sinkfn.SinkResponseList, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CloseAndRecv")
	ret0, _ := ret[0].(*sinkfn.SinkResponseList)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockSink_SinkFnClient) Send(arg0 *sinkfn.SinkRequest) error {
	m.ctrl.T.Helper()
