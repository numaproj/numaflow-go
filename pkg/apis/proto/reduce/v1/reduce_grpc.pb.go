...
func (c *reduceClient) ReduceFn(ctx context.Context, opts ...grpc.CallOption) (Reduce_ReduceFnClient, error) {
	stream, err := c.cc.NewStream(ctx, &Reduce_ServiceDesc.Streams[0], Reduce_ReduceFn_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *reduceClient) IsReady(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ReadyResponse, error) {
	...
	err := c.cc.Invoke(ctx, Reduce_IsReady_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
