...
const (
	Reduce_ReduceFn_FullMethodName = "/reduce.v1.Reduce/ReduceFn"
	Reduce_IsReady_FullMethodName  = "/reduce.v1.Reduce/IsReady"
)
...
func (c *reduceClient) ReduceFn(ctx context.Context, opts ...grpc.CallOption) (Reduce_ReduceFnClient, error) {
	...
	stream, err := c.cc.NewStream(ctx, &Reduce_ServiceDesc.Streams[0], Reduce_ReduceFn_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &reduceReduceFnClient{ClientStream: stream}
	return x, nil
}
...
func (c *reduceClient) IsReady(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ReadyResponse, error) {
	...
	err := c.cc.Invoke(ctx, Reduce_IsReady_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Reduce_ReduceFn_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ReduceServer).ReduceFn(&reduceReduceFnServer{ServerStream: stream})
}
...
func _Reduce_IsReady_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Reduce_IsReady_FullMethodName,
	}
