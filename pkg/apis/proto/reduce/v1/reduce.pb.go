...
var file_pkg_apis_proto_reduce_v1_reduce_proto_rawDesc = string([]byte{
...
var (
	...
	file_pkg_apis_proto_reduce_v1_reduce_proto_rawDescData []byte
)
...
func file_pkg_apis_proto_reduce_v1_reduce_proto_rawDescGZIP() []byte {
	file_pkg_apis_proto_reduce_v1_reduce_proto_rawDescOnce.Do(func() {
		file_pkg_apis_proto_reduce_v1_reduce_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_pkg_apis_proto_reduce_v1_reduce_proto_rawDesc), len(file_pkg_apis_proto_reduce_v1_reduce_proto_rawDesc)))
	})
...
func file_pkg_apis_proto_reduce_v1_reduce_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_pkg_apis_proto_reduce_v1_reduce_proto_rawDesc), len(file_pkg_apis_proto_reduce_v1_reduce_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   1,
