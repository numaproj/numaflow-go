...
//
//	mockgen -destination sideinputmock/sideinputmock.go -package sideinputmock github.com/numaproj/numaflow-go/pkg/apis/proto/sideinput/v1 SideInputClient
//
...
func (m *MockSideInputClient) IsReady(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*v1.ReadyResponse, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
...
func (mr *MockSideInputClientMockRecorder) IsReady(ctx, in any, opts ...any) *gomock.Call {
...
func (m *MockSideInputClient) RetrieveSideInput(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*v1.SideInputResponse, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
...
func (mr *MockSideInputClientMockRecorder) RetrieveSideInput(ctx, in any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, in}, opts...)
