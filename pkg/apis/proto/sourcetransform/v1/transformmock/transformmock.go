...
// Source: github.com/numaproj/numaflow-go/pkg/apis/proto/sourcetransform/v1 (interfaces: SourceTransformerClient)

// Package transformmock is a generated GoMock package.
...
func (m *MockSourceTransformerClient) SourceTransformer(arg0 context.Context, arg1 *v1.SourceTransformRequest, arg2 ...grpc.CallOption) (*v1.SourceTransformResponse, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
