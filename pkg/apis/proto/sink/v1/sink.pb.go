...
type SinkRequest struct {
	...
	Status *SinkRequest_Status `protobuf:"bytes,2,opt,name=status,proto3" json:"status,omitempty"`
...
func (x *SinkRequest) GetStatus() *SinkRequest_Status {
	if x != nil {
		return x.Status
	}
	return nil
...
type SinkResponse struct {
	...
	Result    *SinkResponse_Result `protobuf:"bytes,1,opt,name=result,proto3" json:"result,omitempty"`
...
func (x *SinkResponse) GetResult() *SinkResponse_Result {
	if x != nil {
		return x.Result
	}
	return nil
...
type SinkRequest_Status struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *SinkRequest_Status) Reset() {
	*x = SinkRequest_Status{}
	if protoimpl.UnsafeEnabled {
...
func (x *SinkRequest_Status) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SinkRequest_Status) ProtoMessage() {}

func (x *SinkRequest_Status) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_apis_proto_sink_v1_sink_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SinkRequest_Status.ProtoReflect.Descriptor instead.
func (*SinkRequest_Status) Descriptor() ([]byte, []int) {
	return file_pkg_apis_proto_sink_v1_sink_proto_rawDescGZIP(), []int{0, 1}
}

func (x *SinkRequest_Status) GetEot() bool {
	if x != nil {
		return x.Eot
	}
	return false
...
func (*SinkResponse_Result) Descriptor() ([]byte, []int) {
	return file_pkg_apis_proto_sink_v1_sink_proto_rawDescGZIP(), []int{3, 0}
}
...
var file_pkg_apis_proto_sink_v1_sink_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x97, 0x04, 0x0a, 0x0b, 0x53,
	...
	0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x73, 0x69, 0x6e, 0x6b, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x69, 0x6e,
	0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x52,
	...
	,
	...
	0x74, 0x12, 0x35, 0x0a, 0x09, 0x68, 0x61, 0x6e, 0x64, 0x73, 0x68, 0x61, 0x6b, 0x65, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x73, 0x69, 0x6e, 0x6b, 0x2e, 0x76, 0x31, 0x2e, 0x48,
	0x61, 0x6e, 0x64, 0x73, 0x68, 0x61, 0x6b, 0x65, 0x48, 0x00, 0x52, 0x09, 0x68, 0x61, 0x6e, 0x64,
	0x73, 0x68, 0x61, 0x6b, 0x65, 0x88, 0x01, 0x01, 0x1a, 0x5a, 0x0a, 0x06, 0x52, 0x65, 0x73, 0x75,
	...
	,
...
var file_pkg_apis_proto_sink_v1_sink_proto_goTypes = []any{
	...
	(*SinkResponse)(nil),          // 4: sink.v1.SinkResponse
	(*SinkRequest_Request)(nil),   // 5: sink.v1.SinkRequest.Request
	(*SinkRequest_Status)(nil),    // 6: sink.v1.SinkRequest.Status
...
var file_pkg_apis_proto_sink_v1_sink_proto_depIdxs = []int32{
	5,  // 0: sink.v1.SinkRequest.request:type_name -> sink.v1.SinkRequest.Request
	6,  // 1: sink.v1.SinkRequest.status:type_name -> sink.v1.SinkRequest.Status
	2,  // 2: sink.v1.SinkRequest.handshake:type_name -> sink.v1.Handshake
	8,  // 3: sink.v1.SinkResponse.result:type_name -> sink.v1.SinkResponse.Result
	2,  // 4: sink.v1.SinkResponse.handshake:type_name -> sink.v1.Handshake
	9,  // 5: sink.v1.SinkRequest.Request.event_time:type_name -> google.protobuf.Timestamp
	9,  // 6: sink.v1.SinkRequest.Request.watermark:type_name -> google.protobuf.Timestamp
	7,  // 7: sink.v1.SinkRequest.Request.headers:type_name -> sink.v1.SinkRequest.Request.HeadersEntry
	0,  // 8: sink.v1.SinkResponse.Result.status:type_name -> sink.v1.Status
	1,  // 9: sink.v1.Sink.SinkFn:input_type -> sink.v1.SinkRequest
	10, // 10: sink.v1.Sink.IsReady:input_type -> google.protobuf.Empty
	4,  // 11: sink.v1.Sink.SinkFn:output_type -> sink.v1.SinkResponse
	3,  // 12: sink.v1.Sink.IsReady:output_type -> sink.v1.ReadyResponse
...
func file_pkg_apis_proto_sink_v1_sink_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_pkg_apis_proto_sink_v1_sink_proto_msgTypes[5].Exporter = func(v any, i int) any {
			switch v := v.(*SinkRequest_Status); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_pkg_apis_proto_sink_v1_sink_proto_msgTypes[3].OneofWrappers = []any{}
	type x struct{}
