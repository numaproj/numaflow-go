...
//
//	mockgen -destination sessionreducemock/sessionreducemock.go -package sessionreducemock github.com/numaproj/numaflow-go/pkg/apis/proto/sessionreduce/v1 SessionReduceClient,SessionReduce_SessionReduceFnClient
//
...
func (m *MockSessionReduceClient) IsReady(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*v1.ReadyResponse, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
...
func (mr *MockSessionReduceClientMockRecorder) IsReady(ctx, in any, opts ...any) *gomock.Call {
...
func (m *MockSessionReduceClient) SessionReduceFn(ctx context.Context, opts ...grpc.CallOption) (v1.SessionReduce_SessionReduceFnClient, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx}
	for _, a := range opts {
		varargs = append(varargs, a)
...
func (mr *MockSessionReduceClientMockRecorder) SessionReduceFn(ctx any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m_2 *MockSessionReduce_SessionReduceFnClient) RecvMsg(m any) error {
	m_2.ctrl.T.Helper()
...
func (mr *MockSessionReduce_SessionReduceFnClientMockRecorder) RecvMsg(m any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RecvMsg", reflect.TypeOf((*MockSessionReduce_SessionReduceFnClient)(nil).RecvMsg), m)
}
...
func (mr *MockSessionReduce_SessionReduceFnClientMockRecorder) Send(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (m_2 *MockSessionReduce_SessionReduceFnClient) SendMsg(m any) error {
	m_2.ctrl.T.Helper()
...
func (mr *MockSessionReduce_SessionReduceFnClientMockRecorder) SendMsg(m any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendMsg", reflect.TypeOf((*MockSessionReduce_SessionReduceFnClient)(nil).SendMsg), m)
}
