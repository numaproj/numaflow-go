...
func (SessionReduceRequest_WindowOperation_Event) Descriptor() protoreflect.EnumDescriptor {
	return file_sessionreduce_proto_enumTypes[0].Descriptor()
}

func (SessionReduceRequest_WindowOperation_Event) Type() protoreflect.EnumType {
	return &file_sessionreduce_proto_enumTypes[0]
}
...
func (SessionReduceRequest_WindowOperation_Event) EnumDescriptor() ([]byte, []int) {
	return file_sessionreduce_proto_rawDescGZIP(), []int{1, 0, 0}
}
...
func (x *KeyedWindow) Reset() {
	*x = KeyedWindow{}
	if protoimpl.UnsafeEnabled {
		mi := &file_sessionreduce_proto_msgTypes[0]
...
func (*KeyedWindow) Descriptor() ([]byte, []int) {
	return file_sessionreduce_proto_rawDescGZIP(), []int{0}
}
...
func (x *SessionReduceRequest) Reset() {
	*x = SessionReduceRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_sessionreduce_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SessionReduceRequest) Descriptor() ([]byte, []int) {
	return file_sessionreduce_proto_rawDescGZIP(), []int{1}
}
...
func (x *SessionReduceResponse) Reset() {
	*x = SessionReduceResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_sessionreduce_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SessionReduceResponse) Descriptor() ([]byte, []int) {
	return file_sessionreduce_proto_rawDescGZIP(), []int{2}
}
...
func (x *ReadyResponse) Reset() {
	*x = ReadyResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_sessionreduce_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*ReadyResponse) Descriptor() ([]byte, []int) {
	return file_sessionreduce_proto_rawDescGZIP(), []int{3}
}
...
func (x *SessionReduceRequest_WindowOperation) Reset() {
	*x = SessionReduceRequest_WindowOperation{}
	if protoimpl.UnsafeEnabled {
		mi := &file_sessionreduce_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SessionReduceRequest_WindowOperation) Descriptor() ([]byte, []int) {
	return file_sessionreduce_proto_rawDescGZIP(), []int{1, 0}
}
...
func (x *SessionReduceRequest_Payload) Reset() {
	*x = SessionReduceRequest_Payload{}
	if protoimpl.UnsafeEnabled {
		mi := &file_sessionreduce_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SessionReduceRequest_Payload) Descriptor() ([]byte, []int) {
	return file_sessionreduce_proto_rawDescGZIP(), []int{1, 1}
}
...
func (x *SessionReduceResponse_Result) Reset() {
	*x = SessionReduceResponse_Result{}
	if protoimpl.UnsafeEnabled {
		mi := &file_sessionreduce_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SessionReduceResponse_Result) Descriptor() ([]byte, []int) {
	return file_sessionreduce_proto_rawDescGZIP(), []int{2, 0}
}
...
var File_sessionreduce_proto protoreflect.FileDescriptor

var file_sessionreduce_proto_rawDesc = []byte{
	0x0a, 0x13, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x72, 0x65, 0x64, 0x75, 0x63, 0x65, 0x2e,
	...
	0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x09, 0x52, 0x04, 0x6b, 0x65, 0x79, 0x73, 0x22, 0xcd, 0x04,
	...
	0x10, 0x04, 0x1a, 0xa8, 0x01, 0x0a, 0x07, 0x50, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x12, 0x12,
	...
	,
	...
	0x20, 0x03, 0x28, 0x09, 0x52, 0x04, 0x74, 0x61, 0x67, 0x73, 0x22, 0x25, 0x0a, 0x0d, 0x52, 0x65,
	...
	0x79, 0x32, 0xbb, 0x01, 0x0a, 0x0d, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x64,
	0x75, 0x63, 0x65, 0x12, 0x66, 0x0a, 0x0f, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x52, 0x65,
	0x64, 0x75, 0x63, 0x65, 0x46, 0x6e, 0x12, 0x26, 0x2e, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e,
	0x72, 0x65, 0x64, 0x75, 0x63, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f,
	0x6e, 0x52, 0x65, 0x64, 0x75, 0x63, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x27,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x28, 0x01, 0x30, 0x01, 0x12, 0x42, 0x0a, 0x07, 0x49,
	...
	0x68, 0x0a, 0x25, 0x69, 0x6f, 0x2e, 0x6e, 0x75, 0x6d, 0x61, 0x70, 0x72, 0x6f, 0x6a, 0x2e, 0x6e,
	0x75, 0x6d, 0x61, 0x66, 0x6c, 0x6f, 0x77, 0x2e, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x72,
	0x65, 0x64, 0x75, 0x63, 0x65, 0x2e, 0x76, 0x31, 0x5a, 0x3f, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
	...
	0x69, 0x73, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e,
	0x72, 0x65, 0x64, 0x75, 0x63, 0x65, 0x2f, 0x76, 0x31, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}

var (
	file_sessionreduce_proto_rawDescOnce sync.Once
	file_sessionreduce_proto_rawDescData = file_sessionreduce_proto_rawDesc
)

func file_sessionreduce_proto_rawDescGZIP() []byte {
	file_sessionreduce_proto_rawDescOnce.Do(func() {
		file_sessionreduce_proto_rawDescData = protoimpl.X.CompressGZIP(file_sessionreduce_proto_rawDescData)
	})
	return file_sessionreduce_proto_rawDescData
}

var file_sessionreduce_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_sessionreduce_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_sessionreduce_proto_goTypes = []interface{}{
...
var file_sessionreduce_proto_depIdxs = []int32{
	8,  // 0: sessionreduce.v1.KeyedWindow.start:type_name -> google.protobuf.Timestamp
	8,  // 1: sessionreduce.v1.KeyedWindow.end:type_name -> google.protobuf.Timestamp
	...
	2,  // 10: sessionreduce.v1.SessionReduce.SessionReduceFn:input_type -> sessionreduce.v1.SessionReduceRequest
	9,  // 11: sessionreduce.v1.SessionReduce.IsReady:input_type -> google.protobuf.Empty
	3,  // 12: sessionreduce.v1.SessionReduce.SessionReduceFn:output_type -> sessionreduce.v1.SessionReduceResponse
	4,  // 13: sessionreduce.v1.SessionReduce.IsReady:output_type -> sessionreduce.v1.ReadyResponse
...
func init() { file_sessionreduce_proto_init() }
func file_sessionreduce_proto_init() {
	if File_sessionreduce_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_sessionreduce_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_sessionreduce_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_sessionreduce_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_sessionreduce_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_sessionreduce_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_sessionreduce_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_sessionreduce_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_sessionreduce_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_sessionreduce_proto_goTypes,
		DependencyIndexes: file_sessionreduce_proto_depIdxs,
		EnumInfos:         file_sessionreduce_proto_enumTypes,
		MessageInfos:      file_sessionreduce_proto_msgTypes,
	}.Build()
	File_sessionreduce_proto = out.File
	file_sessionreduce_proto_rawDesc = nil
	file_sessionreduce_proto_goTypes = nil
	file_sessionreduce_proto_depIdxs = nil
}
