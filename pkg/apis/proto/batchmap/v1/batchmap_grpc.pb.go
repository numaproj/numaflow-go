...
const (
	BatchMap_IsReady_FullMethodName    = "/batchmap.v1.BatchMap/IsReady"
	BatchMap_BatchMapFn_FullMethodName = "/batchmap.v1.BatchMap/BatchMapFn"
)
...
func (c *batchMapClient) IsReady(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ReadyResponse, error) {
	...
	err := c.cc.Invoke(ctx, BatchMap_IsReady_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *batchMapClient) BatchMapFn(ctx context.Context, opts ...grpc.CallOption) (BatchMap_BatchMapFnClient, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &BatchMap_ServiceDesc.Streams[0], BatchMap_BatchMapFn_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &batchMapBatchMapFnClient{ClientStream: stream}
	return x, nil
}
...
func _BatchMap_IsReady_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BatchMap_IsReady_FullMethodName,
	}
...
func _BatchMap_BatchMapFn_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(BatchMapServer).BatchMapFn(&batchMapBatchMapFnServer{ServerStream: stream})
}
