...
func (x *userDefinedFunctionReduceFnClient) Recv() (*DatumList, error) {
	m := new(DatumList)
...
func (x *userDefinedFunctionReduceFnServer) Send(m *DatumList) error {
