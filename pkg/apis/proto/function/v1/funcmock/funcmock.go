...
// Source: github.com/KeranYang/numaflow-go/pkg/apis/proto/function/v1 (interfaces: UserDefinedFunctionClient,UserDefinedFunction_ReduceFnClient,UserDefinedFunction_MapStreamFnClient)
...
func (m *MockUserDefinedFunctionClient) MapStreamFn(arg0 context.Context, arg1 *v1.DatumRequest, arg2 ...grpc.CallOption) (v1.UserDefinedFunction_MapStreamFnClient, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(v1.UserDefinedFunction_MapStreamFnClient)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// MapStreamFn indicates an expected call of MapStreamFn.
func (mr *MockUserDefinedFunctionClientMockRecorder) MapStreamFn(arg0, arg1 interface{}, arg2 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{arg0, arg1}, arg2...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "MapStreamFn", reflect.TypeOf((*MockUserDefinedFunctionClient)(nil).MapStreamFn), varargs...)
}
...
// MockUserDefinedFunction_MapStreamFnClient is a mock of UserDefinedFunction_MapStreamFnClient interface.
type MockUserDefinedFunction_MapStreamFnClient struct {
	ctrl     *gomock.Controller
	recorder *MockUserDefinedFunction_MapStreamFnClientMockRecorder
}

// MockUserDefinedFunction_MapStreamFnClientMockRecorder is the mock recorder for MockUserDefinedFunction_MapStreamFnClient.
type MockUserDefinedFunction_MapStreamFnClientMockRecorder struct {
	mock *MockUserDefinedFunction_MapStreamFnClient
}

// NewMockUserDefinedFunction_MapStreamFnClient creates a new mock instance.
func NewMockUserDefinedFunction_MapStreamFnClient(ctrl *gomock.Controller) *MockUserDefinedFunction_MapStreamFnClient {
	mock := &MockUserDefinedFunction_MapStreamFnClient{ctrl: ctrl}
	mock.recorder = &MockUserDefinedFunction_MapStreamFnClientMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockUserDefinedFunction_MapStreamFnClient) EXPECT() *MockUserDefinedFunction_MapStreamFnClientMockRecorder {
	return m.recorder
}

// CloseSend mocks base method.
func (m *MockUserDefinedFunction_MapStreamFnClient) CloseSend() error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CloseSend")
	ret0, _ := ret[0].(error)
	return ret0
...
// CloseSend indicates an expected call of CloseSend.
func (mr *MockUserDefinedFunction_MapStreamFnClientMockRecorder) CloseSend() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CloseSend", reflect.TypeOf((*MockUserDefinedFunction_MapStreamFnClient)(nil).CloseSend))
}

// Context mocks base method.
func (m *MockUserDefinedFunction_MapStreamFnClient) Context() context.Context {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Context")
	ret0, _ := ret[0].(context.Context)
	return ret0
...
// Context indicates an expected call of Context.
func (mr *MockUserDefinedFunction_MapStreamFnClientMockRecorder) Context() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Context", reflect.TypeOf((*MockUserDefinedFunction_MapStreamFnClient)(nil).Context))
}

// Header mocks base method.
func (m *MockUserDefinedFunction_MapStreamFnClient) Header() (metadata.MD, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Header")
	ret0, _ := ret[0].(metadata.MD)
	ret1, _ := ret[1].(error)
...
// Header indicates an expected call of Header.
func (mr *MockUserDefinedFunction_MapStreamFnClientMockRecorder) Header() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Header", reflect.TypeOf((*MockUserDefinedFunction_MapStreamFnClient)(nil).Header))
}
...
// Recv indicates an expected call of Recv.
func (mr *MockUserDefinedFunction_MapStreamFnClientMockRecorder) Recv() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Recv", reflect.TypeOf((*MockUserDefinedFunction_MapStreamFnClient)(nil).Recv))
}

// RecvMsg mocks base method.
func (m *MockUserDefinedFunction_MapStreamFnClient) RecvMsg(arg0 interface{}) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RecvMsg", arg0)
	ret0, _ := ret[0].(error)
	return ret0
...
// RecvMsg indicates an expected call of RecvMsg.
func (mr *MockUserDefinedFunction_MapStreamFnClientMockRecorder) RecvMsg(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RecvMsg", reflect.TypeOf((*MockUserDefinedFunction_MapStreamFnClient)(nil).RecvMsg), arg0)
}

// SendMsg mocks base method.
func (m *MockUserDefinedFunction_MapStreamFnClient) SendMsg(arg0 interface{}) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SendMsg", arg0)
	ret0, _ := ret[0].(error)
	return ret0
...
// SendMsg indicates an expected call of SendMsg.
func (mr *MockUserDefinedFunction_MapStreamFnClientMockRecorder) SendMsg(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SendMsg", reflect.TypeOf((*MockUserDefinedFunction_MapStreamFnClient)(nil).SendMsg), arg0)
}

// Trailer mocks base method.
func (m *MockUserDefinedFunction_MapStreamFnClient) Trailer() metadata.MD {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Trailer")
	ret0, _ := ret[0].(metadata.MD)
	return ret0
...
// Trailer indicates an expected call of Trailer.
func (mr *MockUserDefinedFunction_MapStreamFnClientMockRecorder) Trailer() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Trailer", reflect.TypeOf((*MockUserDefinedFunction_MapStreamFnClient)(nil).Trailer))
}
